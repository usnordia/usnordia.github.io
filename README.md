...
jokes on the icanhazdadjoke.com web page. With queries as part of the
...
```
3. Observe the output as an array of jokes per the ID (id) of each. There are 744 jokes and 38 pages.
